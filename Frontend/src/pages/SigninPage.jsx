    ...
    <div className="w-full h-screen flex flex-col md:flex-row bg-black">
      ...
      <div className="w-full md:w-1/2 min-h-[50%] flex items-center justify-center p-6 bg-white md:bg-black 
        ...
        >
          ...
          <p className="mt-20 md:mt-[15%] text-lg md:text-xl font-medium text-center">
            To short, first register yourself
          </p>
          ...
          <div className="mt-6 flex flex-col gap-5 w-full items-center">
            ...
            <AnimatePresence>
              {touched && (
                <motion.ul
                  className="text-sm w-[80%] text-left text-red-600 md:text-red-400 space-y-1"
                  initial={{ opacity: 0, y: -10 }}
                  animate={{ opacity: 1, y: 0 }}
                  exit={{ opacity: 0 }}
                >
                  {!passwordChecks.length && <li>• At least 8 characters</li>}
                  {!passwordChecks.upper && <li>• At least 1 uppercase letter</li>}
                  {!passwordChecks.lower && <li>• At least 1 lowercase letter</li>}
                  {!passwordChecks.number && <li>• At least 1 number</li>}
            ...
            <button
              ...
              className={`py-3 w-[80%] text-xl font-bold rounded-3xl transition-all duration-200 ${
                isPasswordValid
                  ? 'bg-black md:bg-white text-white md:text-black hover:bg-gray-700 md:hover:bg-gray-400 md:hover:text-white'
